            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_ayah_kandung"
                        ...
                        value="{{ old('nama_ayah_kandung', $anggotaKeluarga->nama_ayah_kandung) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_ibu_kandung"
                        ...
                        value="{{ old('nama_ibu_kandung', $anggotaKeluarga->nama_ibu_kandung) }}" required>
                ...
                <div class="form-group">
                    ...
                    <select name="status_kependudukan_id" id="status_kependudukan_id" class="form-control" required>
                        ...
                        @foreach($statusKependudukanOptions as $id => $nama)
                            <option value="{{ $id }}" {{ old('status_kependudukan_id', $anggotaKeluarga->status_kependudukan_id) == $id ? 'selected' : '' }}>
                                {{ $nama }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="status_khusus_id" id="status_khusus_id" class="form-control">
                        ...
                        @foreach($statusKhususOptions as $id => $nama)
                            <option value="{{ $id }}" {{ old('status_khusus_id', $anggotaKeluarga->status_khusus_id) == $id ? 'selected' : '' }}>
                                {{ $nama }}
                            </option>
                        @endforeach
                    </select>
