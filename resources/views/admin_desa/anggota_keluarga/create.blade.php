        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select name="status_perkawinan" class="form-control @error('status_perkawinan') is-invalid @enderror"
                    ...
                    <option value="{{ $option }}" {{ old('status_perkawinan') == $option ? 'selected' : '' }}>
                        {{ $option }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select name="pekerjaan" class="form-control select2 @error('pekerjaan') is-invalid @enderror"
                    ...
                    <option value="{{ $option }}" {{ old('pekerjaan') == $option ? 'selected' : '' }}>{{ $option }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select name="pendidikan" class="form-control @error('pendidikan') is-invalid @enderror"
                    ...
                    <option value="{{ $option }}" {{ old('pendidikan') == $option ? 'selected' : '' }}>{{ $option }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select name="golongan_darah" class="form-control @error('golongan_darah') is-invalid @enderror"
                    ...
                    <option value="{{ $option }}" {{ old('golongan_darah') == $option ? 'selected' : '' }}>{{ $option }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select name="hubungan_keluarga" class="form-control @error('hubungan_keluarga') is-invalid @enderror"
                    ...
                    <option value="{{ $option }}" {{ old('hubungan_keluarga') == $option ? 'selected' : '' }}>
                        {{ $option }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select name="status_kependudukan"
                    ...
                    <option value="{{ $option }}" {{ old('status_kependudukan') == $option ? 'selected' : '' }}>
                        {{ $option }}
                    </option>
                    @endforeach
                </select>
