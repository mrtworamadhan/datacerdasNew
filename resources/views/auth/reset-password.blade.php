...
<head>
    ...
    <title>Reset Password - Desa Cerdas</title>
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-8 bg-white card-shadow overflow-hidden sm:rounded-lg rounded-xl">
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input id="email" class="form-input mt-1 block w-full" type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus autocomplete="username" />
