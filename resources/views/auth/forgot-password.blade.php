...
<head>
    ...
    <title>Lupa Password - Desa Cerdas</title>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 auth-bg">
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-8 bg-white card-shadow overflow-hidden sm:rounded-lg rounded-xl">
            <div class="mb-4 text-sm text-gray-600">
                {{ __('Lupa password Anda? Tidak masalah. Cukup beritahu kami alamat email Anda dan kami akan mengirimkan tautan reset password yang memungkinkan Anda membuat Password yang baru.') }}
            </div>
