...
@section('content')
    <div class="card">
        ...
        <form action="{{ route('portal.fasum.update', $fasum->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                @if (session('error'))
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="nama_fasum" class="form-control @error('nama_fasum') is-invalid @enderror"
                        id="nama_fasum" value="{{ old('nama_fasum', $fasum->nama_fasum) }}" required>
                ...
                <div class="form-group mb-2">
                    ...
                    <select name="kategori" class="form-control @error('kategori') is-invalid @enderror" id="kategori"
                        ...
                        @foreach($jenisFasumOptions as $option)
                            <option value="{{ $option }}" {{ old('kategori', $fasum->kategori) == $option ? 'selected' : '' }}>{{ $option }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea name="alamat_lengkap" class="form-control @error('alamat_lengkap') is-invalid @enderror"
                        id="alamat_lengkap" rows="3" required>{{ old('alamat_lengkap', $fasum->alamat_lengkap) }}</textarea>
                ...
                <div class="row mb-2">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="rw_id" id="rw_id" class="form-select" required>
                            ...
                            @foreach($rws as $rw)
                                <option value="{{ $rw->id }}" {{ old('rw_id', $fasum->rw_id) == $rw->id ? 'selected' : '' }}>
                                    {{ $rw->nomor_rw }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="rt_id" id="rt_id" class="form-select" required>
                            ...
                            @foreach($rts as $rt)
                                <option value="{{ $rt->id }}" {{ old('rt_id', $fasum->rt_id) == $rt->id ? 'selected' : '' }}>
                                    {{ $rt->nomor_rt }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="latitude" class="form-control @error('latitude') is-invalid @enderror"
                                id="latitude" value="{{ old('latitude', $fasum->latitude) }}" placeholder="-6.2088">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="longitude"
                                ...
                                value="{{ old('longitude', $fasum->longitude) }}" placeholder="106.8456">
                ...
                <div class="form-group mb-2">
                    ...
                    <select name="status_kondisi" class="form-control @error('status_kondisi') is-invalid @enderror"
                        ...
                        @foreach($kondisiOptions as $option)
                            <option value="{{ $option }}" {{ old('status_kondisi', $fasum->status_kondisi) == $option ? 'selected' : '' }}>{{ $option }}
                            </option>
                        @endforeach
                    </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="panjang" class="form-control @error('panjang') is-invalid @enderror"
                                id="panjang" value="{{ old('panjang', $fasum->panjang) }}" placeholder="Contoh: 10 meter">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="lebar" class="form-control @error('lebar') is-invalid @enderror"
                                id="lebar" value="{{ old('lebar', $fasum->lebar) }}" placeholder="Contoh: 5 meter">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="luas_area" class="form-control @error('luas_area') is-invalid @enderror"
                        id="luas_area" value="{{ old('luas_area', $fasum->luas_area) }}" placeholder="Contoh: 1000 m²">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="kapasitas" class="form-control @error('kapasitas') is-invalid @enderror"
                        id="kapasitas" value="{{ old('kapasitas', $fasum->kapasitas) }}" placeholder="Contoh: 200 jamaah, 50 siswa">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="kontak_pengelola"
                        ...
                        value="{{ old('kontak_pengelola', $fasum->kontak_pengelola) }}" placeholder="Nama atau Nomor Telepon">
                ...
                <div class="form-group mb-2">
                    ...
                    <select name="status_kepemilikan" class="form-control @error('status_kepemilikan') is-invalid @enderror"
                        ...
                        @foreach($statusKepemilikanOptions as $option)
                            <option value="{{ $option }}" {{ old('status_kepemilikan', $fasum->status_kepemilikan) == $option ? 'selected' : '' }}>
                                {{ $option }}
                            </option>
                        @endforeach
                    </select>
                ...
                {{-- Preview foto lama --}}
                    ...
                    @endif
                {{-- Preview foto baru (dari input file sebelum submit) --}}
                <div id="photos_preview" class="row mt-2 mb-2"></div>
            </div>
